...
const ReactionsTag = memo(
    ({ className, reactions }: ReactionsTagType) => {
    ...
    (prev, next) => {
        return prev.reactions.data === next.reactions.data
    }
)
